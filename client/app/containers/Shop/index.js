  ...
  render() {
    ...
    return (
      <>
        <Helmet>
          <title>
            Heets Online Shop in Dubai | Authentic IQOS Heets in Dubai, UAE
          </title>
          <link rel="canonical" href="https://www.heetsindubai.com/shop" />
          <meta
            name="description"
            content="To get original IQOS Heets in UAE, Dubai from authentic supplier buy from us and contact with us."
          ></meta>
          <meta
            name="keywords"
            content="heets in dubai, heets in UAE, IQOS in dubai, IQOS in UAE, heets, IQOS, Dubai, UAE"
          ></meta>
        </Helmet>
        <div className="shop">
          <Row xs="12">
